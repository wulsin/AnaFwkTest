...
config.General.requestName = 'SubjetFilter_2012C_v1'
...
config.Data.inputDataset = '/JetHT/Run2012C-22Jan2013-v1/AOD'
...
config.Data.publishDataName = 'Run2012C-22Jan2013-SubjetFilter-v1'
