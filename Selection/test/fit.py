...
cmsAndAtlas["WW"].SetMinimum(5.0e-4)
cmsAndAtlas["WW"].SetMaximum(1.0e4)
outputFile.cd()
can.SetName("ww")
can.Write("ww")
...
cmsAndAtlas["WZ"].SetMinimum(5.0e-3)
cmsAndAtlas["WZ"].SetMaximum(1.0e4)
outputFile.cd()
can.SetName("wz")
can.Write("wz")
...
cmsAndAtlas["WZ"].SetMinimum(5.0e-4)
cmsAndAtlas["WZ"].SetMaximum(1.0e4)
outputFile.cd()
can.SetName("zz")
can.Write("zz")
